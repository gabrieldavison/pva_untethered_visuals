!(function (r, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(t)
    : ((r = "undefined" != typeof globalThis ? globalThis : r || self).Meyda =
        t());
})(this, function () {
  "use strict";
  /*! *****************************************************************************
  ...
  var t = Object.freeze({
      ...
      blackman: function (r) {
        for (
          ...
          t[n] = 0.42 - 0.5 * Math.cos(n * e) + 0.08 * Math.cos(n * a);
  ...
  function f(r, t, e) {
    for (
      ...
      (n[s] = s * c),
        (i[s] = ((a = n[s]), 700 * (Math.exp(a / 1125) - 1))),
        (l[s] = Math.floor(((e + 1) * i[s]) / t));
    for (var h = new Array(r), m = 0; m < h.length; m++) {
      h[m] = new Array(e / 2 + 1).fill(0);
      for (s = l[m]; s < l[m + 1]; s++)
        h[m][s] = (s - l[m]) / (l[m + 1] - l[m]);
      for (s = l[m + 1]; s < l[m + 2]; s++)
        h[m][s] = (l[m + 2] - s) / (l[m + 2] - l[m + 1]);
    }
    return h;
  }
    ...
    var l,
      ...
      w = g.map(function (r, t) {
        return r.map(function (r, e) {
          return Math.exp(-0.5 * Math.pow((2 * g[t][e]) / m[e], 2));
        });
      });
    if (
  ...
  var g = Object.freeze({
    ...
    spectralSlope: function (r) {
      ...
      if ("object" != typeof t) throw new TypeError();
      for (
        var n = 0, i = 0, o = new Float32Array(t.length), u = 0, f = 0, c = 0;
        c < t.length;
        c++
      ) {
        n += t[c];
    ...
    spectralRolloff: function (r) {
      ...
      if ("object" != typeof t) throw new TypeError();
      for (
        var a = t, n = e / (2 * (a.length - 1)), i = 0, o = 0;
        o < a.length;
        o++
      )
        i += a[o];
      for (var u = 0.99 * i, f = a.length - 1; i > u && f >= 0; )
        (i -= a[f]), --f;
      return (f + 1) * n;
    },
    ...
    zcr: function (r) {
      ...
      for (var e = 0, a = 1; a < t.length; a++)
        ((t[a - 1] >= 0 && t[a] < 0) || (t[a - 1] < 0 && t[a] >= 0)) && e++;
      return e;
    },
    loudness: s,
    perceptualSpread: function (r) {
      for (
        var t = s({ ampSpectrum: r.ampSpectrum, barkScale: r.barkScale }),
          e = 0,
          a = 0;
        a < t.specific.length;
        a++
    ...
    perceptualSharpness: function (r) {
      for (
        ...
        a += n < 15 ? (n + 1) * e[n + 1] : 0.066 * Math.exp(0.171 * (n + 1));
    ...
    spectralFlux: function (r) {
      var t = r.signal,
        ...
        a = r.bufferSize;
      if ("object" != typeof t || "object" != typeof e) throw new TypeError();
      for (var n = 0, i = -a / 2; i < t.length / 2 - 1; i++)
        (x = Math.abs(t[i]) - Math.abs(e[i])), (n += (x + Math.abs(x)) / 2);
      return n;
    },
  });
  function w(r) {
  ...
  var v = {},
    ...
    _ = {
      bitReverseArray: function (r) {
        if (void 0 === v[r]) {
          for (
            ...
            var i = n.toString(2);
            (i = e.substr(i.length) + i),
              (i = [].concat(w(i)).reverse().join("")),
              (a[n] = parseInt(i, 2));
          }
          v[r] = a;
        }
      ...
      constructComplexArray: function (r) {
        ...
        return (
          void 0 === d[e] &&
            (d[e] = Array.apply(null, Array(e)).map(
    ...
    S = function (r) {
      ...
      for (
        var n = _.bitReverseArray(e), i = { real: [], imag: [] }, o = 0;
        o < e;
        o++
      )
        (i.real[n[o]] = t.real[o]), (i.imag[n[o]] = t.imag[o]);
      for (var u = 0; u < e; u++)
        (t.real[u] = i.real[u]), (t.imag[u] = i.imag[u]);
      for (var f = 1; f <= a; f++)
        for (var c = Math.pow(2, f), l = 0; l < c / 2; l++)
          for (var s = _.euler(l, c), h = 0; h < e / c; h++) {
            var m = c * h + l,
              p = c * h + l + c / 2,
              g = { real: t.real[m], imag: t.imag[m] },
    ...
    b = (function () {
      ...
      return (
        (r.prototype.start = function (r) {
          (this._m._featuresToExtract = r || this._m._featuresToExtract),
          ...
          r <= this._m.inputs
            ...
            : console.error(
                "Channel " +
                  ...
                  r +
                  " when instantiating the MeydaAnalyzer"
              );
        }),
    ...
    M = {
      ...
      extract: function (r, t, e) {
        ...
        (void 0 !== this.barkScale &&
          ...
          void 0 === t.buffer ? (this.signal = o(t)) : (this.signal = t);
    ...
    F = function (r, t, e) {
      var a = {};
      void 0 === r.buffer ? (a.signal = o(r)) : (a.signal = r),
        (a.windowedSignal = n(a.signal, t)),
        (a.complexSpectrum = y(a.windowedSignal)),
        (a.ampSpectrum = new Float32Array(e / 2));
      for (var i = 0; i < e / 2; i++)
        a.ampSpectrum[i] = Math.sqrt(
          Math.pow(a.complexSpectrum.real[i], 2) +
            Math.pow(a.complexSpectrum.imag[i], 2)
        );
      return a;
    };
